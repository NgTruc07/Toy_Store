    ...
    <div>
      ...
      <div style={{ position: 'relative', textAlign: 'center', margin: '40px 0' }}>
        <img
          ...
          style={{
            width: '80%', maxWidth: '960px', height: 'auto',
            borderRadius: '20px', display: 'block', margin: '0 auto'
          }}
        />
        <div style={{
          position: 'absolute', top: '50%', left: '50%',
          transform: 'translate(-50%, -50%)',
          background: 'rgba(255, 255, 255, 0.85)', padding: '12px 24px',
          borderRadius: '40px', fontSize: '24px',
          fontWeight: 'bold', color: '#c41c1c',
...
function App() {const [showCartPopup, setShowCartPopup] = useState(false);
  ...
  const handleAddToCartPopup = () => {
    ...
    setTimeout(() => setShowCartPopup(false), 2000); // hiện popup trong 2 giây
  };
  ...
  return (
    <Router>
      <div className="App">
        ...
        <ToastContainer autoClose={1000} /> {/*  Toast hiện 1 giây */}
        <Footer />
      </div>
    </Router>
  );
